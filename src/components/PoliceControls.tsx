...
import { Shield, FileText, Radio, Users, MapPin, AlertCircle } from 'lucide-react';
...
const PoliceControls: React.FC<PoliceControlsProps> = ({ 
  selectedTourist, 
  totalTourists, 
  sosCount, 
  outlierCount 
      ...
      <Card className="bg-card/95 backdrop-blur-sm">
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-success">{totalTourists - sosCount - outlierCount}</div>
              <div className="text-xs text-muted-foreground">Safe</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-emergency">{sosCount}</div>
              <div className="text-xs text-muted-foreground">SOS Active</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-warning">{outlierCount}</div>
