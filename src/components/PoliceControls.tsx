  ...
  return (
    <>
      ...
      <Button
        size="sm"
        variant="ghost"
        className="fixed left-4 bottom-32 z-[1200] h-10 w-10 p-0 rounded-r-md shadow-md bg-gradient-to-b from-red-700 to-black text-white"
      ...
      {/* Sliding Panel */}
      <div
        className={`fixed left-4 bottom-36 z-[1100] transition-transform duration-300 ${
          panelVisible ? 'translate-x-0 w-72' : '-translate-x-full w-12'
        }`}
      >
